return {
	...
	opts = {
		...
		per_buffer_config = {
			lines = 9, -- Number of lines showed on preview.
		...
		-- 	keymap.set("n", "H", require("arrow.persist").previous)
		-- 	keymap.set("n", "L", require("arrow.persist").next)
		-- 	keymap.set("n", "<C-s>", require("arrow.persist").toggle)
		-- end,
	},
}
